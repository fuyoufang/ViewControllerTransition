//
//  OverlayWithPresentationAnimationController.swift
...
class OverlayWithPresentationAnimationController: NSObject {
    
    var transitionDuration: TimeInterval = 0.5
    
}

extension OverlayWithPresentationAnimationController: UIViewControllerAnimatedTransitioning {
